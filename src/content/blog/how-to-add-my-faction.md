...
title: How to add my faction
postSlug: how-to-add-my-faction
featured: true
draft: false
tags:
  - docs
ogImage: ""
description: Some informations how to add an new post or faction.
---

This website is based on Astro which is an great tool to create websites with an blog based structure in mind. 

Basicly all the pages on this website are based upon some .md files. .md is the file ending of Markdown. 

## basic guide/tutorial
Watch this 3:31 min video to get started in Markdown to create your own faction pages.

[![markdown tutorial video](https://img.youtube.com/vi/-MXwHMHfF8k/0.jpg)](https://www.youtube.com/watch?v=-MXwHMHfF8k)


## Advanced/further informations
[Astro markdown documantaion](https://docs.astro.build/en/guides/markdown-content/)
